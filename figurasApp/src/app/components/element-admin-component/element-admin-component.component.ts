...
@Component({
  selector: 'app-element-admin-component',
  templateUrl: './element-admin-component.component.html',
  styleUrls: ['./element-admin-component.component.css']
})
export class ElementAdminComponentComponent implements OnInit {
...
uploadSingle() {
  ...
  eliminar(id:string){
    if (id!='') {
      ...
      this.dataService.deleteElemento(elemento);
    }
  }
